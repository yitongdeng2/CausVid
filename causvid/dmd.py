...
from causvid.models import (get_diffusion_wrapper,
                            ...
                            get_text_encoder_wrapper, get_vae_wrapper)
...
class DMD(nn.Module):
    def __init__(self, args, device):
        ...
        self.fake_score = get_diffusion_wrapper(model_name=self.fake_model_name)()
    ...
    def compute_distribution_matching_loss(
        ...
        with torch.no_grad():
            ...
            timestep = self._process_timestep(timestep, type=self.real_task_type)
