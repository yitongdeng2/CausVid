...
from diffusers import DDIMScheduler, DiffusionPipeline, LCMScheduler
from tqdm import tqdm

from causvid.evaluation.coco_eval.coco_evaluator import (compute_clip_score,
                                                         evaluate_model)
...
def main():
    ...
    if dist.get_rank() == 0:
        fid = evaluate_model(args, device, data_dict["all_images"], patch_fid=False)
